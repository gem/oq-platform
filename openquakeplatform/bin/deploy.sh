...
oq_platform_install () {
    ...
    DJANGO_SETTINGS_MODULE='openquakeplatform.settings' python -c "from django.contrib.sites.models import Site; mysite = Site.objects.all()[0]; mysite.domain = '$gem_host_name'; mysite.name = '$gem_host_name'; mysite.save()"
