...
setup(
    ...
    dependency_links = ['http://github.com/gem/geonode/tarball/2.0.2#egg=GeoNode-2.0.2',
                        ...
                        'http://github.com/gem/wadofstuff-django-serializers/tarball/1.1#egg=wadofstuff-django-serializers-1.1',
                        'http://github.com/gem/django-nested-inlines/tarball/0.1#egg=django-nested-inlines-0.1',
                        'http://github.com/gem/django-chained-selectbox/tarball/v0.2#egg=django-chained-selectbox-0.2',
    ...
    install_requires=[
        ...
        "django-appconf==0.6",
        "django-chained-multi-checkboxes >= 0.4, < 0.5",
        "django-chained-selectbox >= 0.2.1, < 0.3",
