// Acquired: https://github.com/jvrousseau/mapboxgl-heatmap
...
Heights = (function () {
    ...
    Heights.prototype.addLine = function (x1, y1, x2, y2, size, intensity) {
        var s;
        if (size == null) {
            size = 50;
        }
        ...
        y2 = this.height - y2;
        s = size / 2;
        this.addVertex(x1, y1, -s, -s, intensity);
        this.addVertex(x1, y1, +s, -s, intensity);
        this.addVertex(x2, y2, -s, +s, intensity);
        this.addVertex(x2, y2, -s, +s, intensity);
        this.addVertex(x1, y1, +s, -s, intensity);
        this.addVertex(x2, y2, +s, +s, intensity);
        return this.pointCount += 1;
...
WebGLHeatmap = (function () {
    ...
    WebGLHeatmap.prototype.addLine = function (x1, y1, x2, y2, size, intensity) {
        return this.heights.addLine(x1, y1, x2, y2, size, intensity);
    };
...
exports.createWebGLHeatmap = function (params) {
