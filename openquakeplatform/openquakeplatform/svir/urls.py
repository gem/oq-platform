...
from openquakeplatform.svir.views import (list_themes,
                                          ...
                                          export_variables_data_national,
                                          export_variables_data_subnational,
...
urlpatterns = patterns(
    ...
    url(r'^export_variables_data_national$',
        export_variables_data_national),
    url(r'^export_variables_data_subnational$',
        export_variables_data_subnational),
    url(r'^export_countries_info$', export_countries_info),
    url(r'^export_zones_info$', export_zones_info),
