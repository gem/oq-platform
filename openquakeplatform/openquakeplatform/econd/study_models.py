...
class Geobase(models.Model):
      ...
      tablename = models.CharField(max_length=255, null=True, default='geobase_', verbose_name='Geobase table name', help_text='The name of the new database table that will contain the boundaries that comprise this geobase. It should start with geobase_ and be of the form "geobase_gadm_china_2" meaning China GADM level 2, and be lowercase with no spaces or punctuation', blank=True, )
...
class Socioeconomicstudy(models.Model):
      ...
      class Meta:
            db_table = u'econd__socioeconomicstudy'
...
class Tsunamistudy(models.Model):
      ...
      class Meta:
            db_table = u'econd__tsunamistudy'
...
class Slopefailurestudy(models.Model):
      ...
      class Meta:
            db_table = u'econd__slopefailurestudy'
...
class Firefollowingstudy(models.Model):
      ...
      class Meta:
            db_table = u'econd__firefollowingstudy'
...
class Liquefactionstudy(models.Model):
      ...
      class Meta:
            db_table = u'econd__liquefactionstudy'
