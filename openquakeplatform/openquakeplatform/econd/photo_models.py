...
#     # MN: unique=True removed because more the 6000 record in gemecd.org are set to "untitled"
...
#     gpsdirectioncode = models.CharField(max_length=10, verbose_name='Camera GPS code', help_text='Direction code taken from GPS information embedded in image', blank=True, )
...
#     subjectmastercode = models.ForeignKey(Lookupsubjectmastercode, null=True, db_column='subjectmastercode', blank=True,verbose_name='Subject master code',default='0', )
...
#     class Meta:
#         db_table = u'econd__photologue_photo'
#         managed = True
...
class Photos (models.Model):
    ...
    thephoto = models.ForeignKey( 'weblib.WebLibPhoto', db_column='photoid', null=True, blank=True, )

    class Meta:
        db_table = u'gemecdphotos'     #note this is a VIEW
        managed = False
...
class GeoArchiveMasterOverview (models.Model):
    ...
    unifieddamagelevelname = models.CharField(max_length=255, verbose_name='Damage level', blank=True, )
    ...
    aggregationtest = models.IntegerField(null=True, blank=True, )
    qualitycode = models.ForeignKey( 'Lookupphotoqualitycode', db_column='qualitycode',null=True, blank=True, )

    class Meta:
        db_table = u'geoarchivemasteroverview'   #note this is a VIEW
        managed = False
...
class GeoArchiveLocations ( models.Model ):
    ...
    photocount= models.IntegerField(verbose_name='Number of photos', null=True, blank=True, )
    inventoryclassname = models.CharField(max_length=255,verbose_name='Inventory class', blank=True, )
    ...
    class Meta:
        db_table = u'geoarchivelocations'     #note this is a VIEW
        managed = False
...
class GeoArchiveLocationsForJSON ( models.Model ):
    ...
    class Meta:
        db_table = u'geoarchivelocationsforjson'     #note this is a VIEW
        managed = False
...
class GeoArchiveEvents ( models.Model ):
    ...
    class Meta:
        db_table = u'geoarchiveevents'     #note this is a VIEW
        managed = False
...
class GeoArchiveEventsQuick ( models.Model ):
    ...
    class Meta:
        db_table = u'geoarchiveevents_quick'     #note this is a VIEW
        managed = False
        ordering = ['-yearint']
...
class GeoArchiveDamageLevels ( models.Model ):
    ...
    class Meta:
        db_table = u'geoarchivedamagelevels'     #note this is a VIEW
        managed = False
...
class GeoArchiveDamageLevelsQuick ( models.Model ):
    ...
    class Meta:
        db_table = u'geoarchivedamagelevels_quick'     #note this is a VIEW
        managed = False
...
class GeoArchiveInventoryClasses ( models.Model ):
    ...
    class Meta:
        db_table = u'geoarchiveinventoryclasses'     #note this is a VIEW
        managed = False
...
class GeoArchiveAssetClasses ( models.Model ):
    ...
    class Meta:
        db_table = u'geoarchiveassetclasses'     #note this is a VIEW
        managed = False
...
class GeoArchiveAssetClassesQuick ( models.Model ):
    ...
    class Meta:
        db_table = u'geoarchiveassetclasses_quick'  # note this is a VIEW
        managed = False
...
class GeoArchiveOverviewFull (models.Model):
    ...
    locationid = models.IntegerField(null=True, blank=True, )
    locationname = models.CharField(max_length=255, blank=True, )
    location_geom = models.TextField(blank=True, null=True, ) # This field type is a guess.
    locationaggregateflag = models.IntegerField(null=True, blank=True, )
    thephoto = models.ForeignKey( 'weblib.WebLibPhoto', db_column='photoid',null=True, blank=True, )
    ...
    class Meta:
        db_table = u'geoarchivemasterfull'
        managed = False
