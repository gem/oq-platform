...
class Event(models.Model):
      ...
      eventdate = models.DateTimeField(null=True, blank=True, verbose_name='Date (UTC)', help_text='The date of the event in UTC, eg 1970-05-31', )
      eventtime = models.DateTimeField(null=True, blank=True, verbose_name='Time (UTC)', help_text='The time of the event in UTC, eg 20:23', )
      eventdatelocal = models.DateTimeField(null=True, blank=True, verbose_name='Date (local)', help_text='The date of the event in local time, eg 1970-05-31', )
      eventtimelocal = models.DateTimeField(null=True, blank=True, verbose_name='Time (local)', help_text='The time of the event in local time, eg 15:23', )
      ...
      geoarchive_flag = models.CharField(max_length=1, null=True, default='n', verbose_name='Geoarchive flag', help_text='Geoarchive flag', blank=True, )
      ...
      peopleinjuredduetoshake = models.BigIntegerField(null=True, blank=True, )
      peopleinjuredduetoshake_s = models.CharField(max_length=255, null=True, blank=True, )
      peopleinjuredduetoshake_c = models.TextField(null=True, blank=True, )
      peopleinjuredduetoshake_q = models.CharField(max_length=10)
      overallimpactshake = models.TextField(null=True, blank=True, )
      peopleinjuredduetotsunami = models.BigIntegerField(null=True, blank=True, )
      peopleinjuredduetotsunami_s = models.CharField(max_length=255, null=True, blank=True, )
      peopleinjuredduetotsunami_c = models.TextField(null=True, blank=True, )
      peopleinjuredduetotsunami_q = models.IntegerField(null=True, blank=True, )
      peopleinjuredduetoslopefailures = models.BigIntegerField(null=True, blank=True, )
      peopleinjuredduetoslopefailures_s = models.CharField(max_length=255, null=True, blank=True, )
      peopleinjuredduetoslopefailures_c = models.TextField(null=True, blank=True, )
      peopleinjuredduetoslopefailures_q = models.IntegerField(null=True, blank=True, )
      peopleinjuredduetofirefollowing = models.BigIntegerField(null=True, blank=True, )
      peopleinjuredduetofirefollowing_s = models.CharField(max_length=255, null=True, blank=True, )
      peopleinjuredduetofirefollowing_c = models.TextField(null=True, blank=True, )
      peopleinjuredduetofirefollowing_q = models.IntegerField(null=True, blank=True, )
      the_geom = gis_models.PointField()
      location_c = models.TextField(null=True)
      objects = gis_models.GeoManager()

      class Meta:
            db_table = u'econd__event'
