...
FaultedEarth = Ext.extend (gxp.Viewer,{
	...
	var propertyNames = Ext.apply({}, faultedearth.properties);
...
faultedearth.properties = {
    ...
    "u_sm_d_pref": "Upper seismogenic depth pref (km)",
    ...
    "slip_type": "Slip type (Reverse etc.)",
    "slip_com": "Slip type completeness (1, 2, 3, or 4)",

    "dip_slip_rate_min": "Slip rate min (mm/yr)",
    "dip_slip_rate_max": "Slip rate max (mm/yr)",
    "dip_slip_rate_pref": "Slip rate pref (mm/yr)",
    "net_slip_rate_min": "Slip rate min (mm/yr)",
    "net_slip_rate_max": "Slip rate max (mm/yr)",
    "net_slip_rate_pref": "Slip rate pref (mm/yr)",
    "net_slip_rate_com": "Slip rate completeness (1, 2, 3, or 4)",
    "strike_slip_rate_min": "Slip rate min (mm/yr)",
    "strike_slip_rate_max": "Slip rate max (mm/yr)",
    "strike_slip_rate_pref": "Slip rate pref (mm/yr)",
    "vertical_slip_rate_min": "Slip rate min (mm/yr)",
    "vertical_slip_rate_max": "Slip rate max (mm/yr)",
    "vertical_slip_rate_pref": "Slip rate pref (mm/yr)",
    ...
    "slip_type": "Slip Type",
    "hv_ratio": "H:V Ratio",
    "hv_ratio_min": "H:V Ratio (min)",
    "hv_ratio_max": "H:V Ratio (max)",
    "hv_ratio_pref": "H:V Ratio (pref)",
    "rake": "Rake (deg)",
