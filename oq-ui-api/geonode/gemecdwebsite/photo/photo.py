...
from econd.models import WebLibPhoto as Photo
from econd.models import Location
from econd.models import Study, Event
...
class PhotoPage (Pagebase):
    ...
    def dispatch (self, request, *args, **kwargs):
        ...
        if self.preProcessPage(request, **kwargs):
            ...
            # get photo record
            try:
                current_object = Photo.objects.get(pk=ix)
            except:
