...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ghec_viewer_measure', (
            ...
            ('mon', self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True)),
            ('day', self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True)),
            ('hou', self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True)),
            ('min', self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True)),
            ('sec', self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True)),
            ...
            ('latunc', self.gf('django.db.models.fields.FloatField')(default='', null=True, blank=True)),
            ('lonunc', self.gf('django.db.models.fields.FloatField')(default='', null=True, blank=True)),
            ('epdet', self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True)),
            ('dep', self.gf('django.db.models.fields.FloatField')(default='', null=True, blank=True)),
            ...
            ('munc', self.gf('django.db.models.fields.FloatField')(default='', null=True, blank=True)),
            ...
            ('mdpn', self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True)),
            ...
            ('rem', self.gf('django.db.models.fields.CharField')(default='', max_length=1014, null=True, blank=True)),
        ))
    ...
    models = {
        'ghec_viewer.measure': {
            ...
            'day': ('django.db.models.fields.IntegerField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'dep': ('django.db.models.fields.FloatField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            ...
            'hou': ('django.db.models.fields.IntegerField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'io': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'lat': ('django.db.models.fields.FloatField', [], {}),
            'latunc': ('django.db.models.fields.FloatField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'lon': ('django.db.models.fields.FloatField', [], {}),
            'lonunc': ('django.db.models.fields.FloatField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            ...
            'mdpn': ('django.db.models.fields.IntegerField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            ...
            'min': ('django.db.models.fields.IntegerField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'mon': ('django.db.models.fields.IntegerField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            ...
            'munc': ('django.db.models.fields.FloatField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'rem': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1014', 'null': 'True', 'blank': 'True'}),
            'sec': ('django.db.models.fields.IntegerField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
