...
class Measure(models.Model):
    ...
    mon    = models.IntegerField(default='', null=True, blank=True)
    day    = models.IntegerField(default='', null=True, blank=True)
    hou    = models.IntegerField(default='', null=True, blank=True)
    min    = models.IntegerField(default='', null=True, blank=True)
    sec    = models.IntegerField(default='', null=True, blank=True)
