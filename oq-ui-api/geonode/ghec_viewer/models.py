...
class Measure(models.Model):
    ...
    hou    = models.IntegerField(null=True, blank=True)
    ...
    latunc = models.FloatField(null=True, blank=True)
    lonunc = models.FloatField(null=True, blank=True)
    ...
    dep    = models.FloatField(null=True, blank=True)
    ...
    munc   = models.FloatField(null=True, blank=True)
    ...
    mdpn   = models.IntegerField(null=True, blank=True)
