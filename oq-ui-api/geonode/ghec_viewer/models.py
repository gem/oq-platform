...
# En    Source    Year      Mo        Da        Ho        Mi        Se        Area      Lat       Lon       LatUnc    LonUnc    EpDet     Dep       Io        Msource   M         MUnc      MType     MDet      MDPSource         MDPn      MDPIx     MDPsc     Remarks
# en(y) src(y)    yea(y)    mon(n)    day(n)    hou(n)    min(n)    sec(n)    are(n)    lat(y)    lon(y)    latunc(n) lonunc(n) epdet(n)  dep(n)    io(n)     msrc(y)   m(y)      munc(n)   mtyp(n)   mdet(n)   mdpsrc(n)         mdpn(n)   mdpix(n)  mdpsc(n)  rem(n)
#  

class Measure(models.Model):
    en     = models.CharField(max_length=255, null=False, blank=False)
    src    = models.CharField(max_length=255, null=False, blank=False)
    yea    = models.IntegerField(null=False, null=False, blank=False)
    mon    = models.IntegerField(null=False, default='', null=True, blank=True)
    day    = models.IntegerField(null=False, default='', null=True, blank=True)
    hou    = models.IntegerField(null=False, default='', null=True, blank=True)
    min    = models.IntegerField(null=False, default='', null=True, blank=True)
    sec    = models.IntegerField(null=False, default='', null=True, blank=True)
    ...
    latunc = models.FloatField(default='', null=True, blank=True)
    lonunc = models.FloatField(default='', null=True, blank=True)
    ...
    dep    = models.FloatField(default = '', null=True, blank=True)
    ...
    munc   = models.FloatField(default = '', null=True, blank=True)
