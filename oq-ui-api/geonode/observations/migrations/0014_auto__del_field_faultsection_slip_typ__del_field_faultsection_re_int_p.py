...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FaultSection.slip_typ'
        db.delete_column('observations_faultsection', 'slip_typ')

        # Deleting field 'FaultSection.re_int_pre'
        db.delete_column('observations_faultsection', 're_int_pre')

        # Adding field 'FaultSection.slip_type'
        db.add_column('observations_faultsection', 'slip_type', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'FaultSection.re_int_pref'
        db.add_column('observations_faultsection', 're_int_pref', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'FaultSource.slip_typ'
        db.delete_column('observations_faultsource', 'slip_typ')

        # Deleting field 'FaultSource.re_int_pre'
        db.delete_column('observations_faultsource', 're_int_pre')

        # Adding field 'FaultSource.slip_type'
        db.add_column('observations_faultsource', 'slip_type', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'FaultSource.re_int_pref'
        db.add_column('observations_faultsource', 're_int_pref', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Fault.slip_typ'
        db.delete_column('observations_fault', 'slip_typ')

        # Deleting field 'Fault.re_int_pre'
        db.delete_column('observations_fault', 're_int_pre')

        # Adding field 'Fault.slip_type'
        db.add_column('observations_fault', 'slip_type', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'Fault.re_int_pref'
        db.add_column('observations_fault', 're_int_pref', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'FaultSection.slip_typ'
        db.add_column('observations_faultsection', 'slip_typ', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'FaultSection.re_int_pre'
        db.add_column('observations_faultsection', 're_int_pre', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'FaultSection.slip_type'
        db.delete_column('observations_faultsection', 'slip_type')

        # Deleting field 'FaultSection.re_int_pref'
        db.delete_column('observations_faultsection', 're_int_pref')

        # Adding field 'FaultSource.slip_typ'
        db.add_column('observations_faultsource', 'slip_typ', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'FaultSource.re_int_pre'
        db.add_column('observations_faultsource', 're_int_pre', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'FaultSource.slip_type'
        db.delete_column('observations_faultsource', 'slip_type')

        # Deleting field 'FaultSource.re_int_pref'
        db.delete_column('observations_faultsource', 're_int_pref')

        # Adding field 'Fault.slip_typ'
        db.add_column('observations_fault', 'slip_typ', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'Fault.re_int_pre'
        db.add_column('observations_fault', 're_int_pre', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Fault.slip_type'
        db.delete_column('observations_fault', 'slip_type')

        # Deleting field 'Fault.re_int_pref'
        db.delete_column('observations_fault', 're_int_pref')
    ...
    models = {
        ...
        'observations.fault': {
            ...
            'slip_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
