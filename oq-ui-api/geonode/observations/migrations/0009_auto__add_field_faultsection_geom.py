...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FaultSection.geom'
        db.add_column('observations_faultsection', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FaultSection.geom'
        db.delete_column('observations_faultsection', 'geom')
