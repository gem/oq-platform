...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FaultSource.source_nm'
        db.alter_column('observations_faultsource', 'source_nm', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'FaultSource.fault_name'
        db.alter_column('observations_faultsource', 'fault_name', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'FaultSource.source_nm'
        db.alter_column('observations_faultsource', 'source_nm', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'FaultSource.fault_name'
        db.alter_column('observations_faultsource', 'fault_name', self.gf('django.db.models.fields.CharField')(max_length=30))
