...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FaultSection.episodi_is'
        db.delete_column('observations_faultsection', 'episodi_is')

        # Deleting field 'FaultSection.episodi_ac'
        db.delete_column('observations_faultsection', 'episodi_ac')

        # Adding field 'FaultSection.episodic_behaviour'
        db.add_column('observations_faultsection', 'episodic_behaviour', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Deleting field 'Fault.episodi_is'
        db.delete_column('observations_fault', 'episodi_is')

        # Deleting field 'Fault.episodi_ac'
        db.delete_column('observations_fault', 'episodi_ac')

        # Adding field 'Fault.episodic_behaviour'
        db.add_column('observations_fault', 'episodic_behaviour', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)
...
SELECT
    ...
    observations_faultsection.episodic_behaviour,
...
SET
    ...
    episodic_behaviour = NEW.episodic_behaviour,
...
""")
        ...
        observations_fault.strike, observations_fault.episodic_behaviour,
...
SET
    ...
    strike = NEW.strike, episodic_behaviour = NEW.episodic_behaviour,
    u_sm_d_min = NEW.u_sm_d_min,
...
WHERE
    ...
    def backwards(self, orm):
        ...
        # Adding field 'FaultSection.episodi_is'
        db.add_column('observations_faultsection', 'episodi_is', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'FaultSection.episodi_ac'
        db.add_column('observations_faultsection', 'episodi_ac', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Deleting field 'FaultSection.episodic_behaviour'
        db.delete_column('observations_faultsection', 'episodic_behaviour')

        # Adding field 'Fault.episodi_is'
        db.add_column('observations_fault', 'episodi_is', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'Fault.episodi_ac'
        db.add_column('observations_fault', 'episodi_ac', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Deleting field 'Fault.episodic_behaviour'
        db.delete_column('observations_fault', 'episodic_behaviour')
