...
class mapping_schema_rural_non_res(models.Model):
    name = models.CharField(max_length=150)
    gmi_cntry = models.CharField(max_length=150)
    region = models.CharField(max_length=150)
    gem_shorth = models.CharField(max_length=150)
    mapping_sc = models.IntegerField(null=True, blank=True)
    ms_name = models.CharField(max_length=150)
    ms_value  = models.FloatField(null=True, blank=True)
    src_id = models.IntegerField(null=True, blank=True)
    is_urban = models.CharField(max_length=150)
    occupancy = models.CharField(max_length=150)
    gadm_count = models.IntegerField(null=True, blank=True)
    the_geom = models.MultiPolygonField(srid=4326)

class mapping_schema_rural_res(models.Model):
    name = models.CharField(max_length=150)
    gmi_cntry = models.CharField(max_length=150)
    region = models.CharField(max_length=150)
    gem_shorth = models.CharField(max_length=150)
...
class mapping_schema_urban_non_res(models.Model):
    name = models.CharField(max_length=150)
    gmi_cntry = models.CharField(max_length=150)
    region = models.CharField(max_length=150)
    gem_shorth = models.CharField(max_length=150)
...
class mapping_schema_urban_res(models.Model):
    name = models.CharField(max_length=150)
    gmi_cntry = models.CharField(max_length=150)
    region = models.CharField(max_length=150)
    gem_shorth = models.CharField(max_length=150)
