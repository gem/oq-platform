...
class Event(models.Model):
      ...
      yearint = models.IntegerField(null=False, default='0', verbose_name='Event year', help_text='Year as a number for sorting purposes', )
      ...
      depth = models.FloatField(verbose_name='Focal depth', help_text='The focal depth of the event, km', )
      ...
      peopleinjured = models.IntegerField(verbose_name='People injured', help_text='Total people injured in event (all hazards)', )
      ...
      peopleseriouslyinjured = models.IntegerField(verbose_name='People seriously injured', help_text='Total people seriously injured and/or hospitalised', )
      ...
      peoplemissing = models.IntegerField(verbose_name='People missing', help_text='Total people missing in event (all hazards)', )
      ...
      peoplekilled = models.IntegerField(verbose_name='People killed', help_text='Total people killed in event (all hazards)', )
      ...
      peopledyingpostcatastrophe = models.IntegerField(verbose_name='People dying post catastrophe', help_text='People dying after time has passed but their deaths related to the original catastrophe (all hazards)', )
      ...
      peoplemissingduetoshake = models.IntegerField(verbose_name='People missing due to ground shaking', help_text='People missing due to ground shaking', )
      ...
      peoplekilledduetoshake = models.IntegerField(verbose_name='People killed due to ground shaking', help_text='People killed due to ground shaking', )
      ...
      peopledyingpostcatastropheshake = models.IntegerField(verbose_name='People dying post catastrophe due to shaking', help_text='People dying after time has passed but their deaths related to the original shaking', )
      ...
      numberofbuildingsdestroyed = models.IntegerField(verbose_name='Total number of buildings destroyed', help_text='Total number of buildings destroyed, collapsed or damaged beyond repair(all hazards)', )
      ...
      numberofbuildingsdamaged = models.IntegerField(verbose_name='Number of buildings damaged', help_text='Total number of buildings damaged (all hazards)', )
      ...
      numberofdwellingsdestroyed = models.IntegerField(verbose_name='Number of dwellings destroyed', help_text='Total number of dwelling units destroyed, collapsed or damaged beyond repair (all hazards)', )
      ...
      numberofdwellingsdamaged = models.IntegerField(verbose_name='Number of dwellings damaged', help_text='Total number of dwelling units damaged (all hazards)', )
      ...
      numberofbuildingsdestroyedshake = models.IntegerField(verbose_name='Total number of buildings destroyed by shaking', help_text='Total number of buildings destroyed, collapsed or damaged beyond repair by shaking', )
      ...
      numberofbuildingsdamagedshake = models.IntegerField(verbose_name='Number of buildings damaged by shaking', help_text='Total number of buildings damaged by shaking', )
      ...
      numberofdwellingsdestroyedshake = models.IntegerField(verbose_name='Number of dwellings destroyed by shaking', help_text='Total number of dwelling units destroyed, collapsed or damaged beyond repair by shaking', )
      ...
      numberofdwellingsdamagedshake = models.IntegerField(verbose_name='Number of dwellings damaged by shaking', help_text='Total number of dwelling units damaged by shaking', )
      ...
      peoplehomeless = models.IntegerField(verbose_name='People homeless', help_text='Total number of people homeless for a significant duration of time (all hazards)', )
      ...
      directeconomicloss = models.FloatField(verbose_name='Direct economic loss', help_text='Total estimated direct economic loss, million US$, contemporaneous. In absolute US$ value of the year of occurrence. Only includes direct effects. (all hazards)', )
      ...
      indirecteconomicloss = models.FloatField(verbose_name='Indirect economic loss', help_text='Total estimated indirect economic loss, million US$, contemporaneous. In absolute US$ value of the year of occurrence. Only includes indirect effects. (all hazards)', )
      ...
      insuredloss = models.FloatField(verbose_name='Insured loss', help_text='Total insured losses, million US$, contemporaneous. In absolute US$ value of the year of occurrence.', )
      ...
      peoplehomelessshake = models.IntegerField(verbose_name='People homeless due to shaking', help_text='Total number of people homeless for a significant duration of time (shaking)', )
      ...
      directeconomiclossshake = models.IntegerField(verbose_name='Direct economic loss due to shaking', help_text='Total estimated direct economic loss due to shaking, million US$, contemporaneous. In absolute US$ value of the year of occurrence. Only includes direct effects.', )
      ...
      indirecteconomiclossshake = models.IntegerField(verbose_name='Indirect economic loss due to shaking', help_text='Total estimated indirect economic loss due to shaking, million US$, contemporaneous. In absolute US$ value of the year of occurrence. Only includes indirect effects. ', )
      ...
      numberofhouseholds = models.IntegerField(verbose_name='Number of households', help_text='Total number of households in the affected countries (contemporaneous)', )
      ...
      totalnumberofbuildings = models.IntegerField(verbose_name='Total number of buildings', help_text='Total number of buildings in the affected countries (contemporaneous)', )
      ...
      numberofhouseholdsshake = models.IntegerField(verbose_name='Number of households affected by shaking', help_text='Total number of households in the zone affected by shaking (contemporaneous)', )
      ...
      totalnumberofbuildingsshake = models.IntegerField(verbose_name='Total number of buildings affected by shaking', help_text='Total number of buildings in the zone affected by shaking (contemporaneous)', )
      ...
      population = models.IntegerField(verbose_name='Population', help_text='Population in the affected countries (contemporaneous)', )
      ...
      geoarchive_flag = models.CharField(max_length=1, null=False, default='n', verbose_name='Geoarchive flag', help_text='Geoarchive flag', )
