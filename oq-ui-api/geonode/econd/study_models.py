...
class Geobase(models.Model):
      ...
      name = models.CharField(max_length=255, null=False, default='unknown', verbose_name='Geobase name', help_text='The name of the geobase, in the form country_GADM level number e.g. Italy_1 or Japan_2. ', blank=True, )
      regioncode = models.ForeignKey(Lookupregion, db_column='regioncode', max_length=255, null=False, default='0', verbose_name='World region', help_text='The region of the world where the geobase is located', blank=True, )
      ...
      ownerid = models.IntegerField(null=False, default='1', verbose_name='Owner ID', help_text='ID of the creator/owner of the record', max_length=255, blank=True, )
      lastupdatebyid = models.IntegerField(null=False, default='1', verbose_name='Last update by ID', help_text='ID of the last person to update this record', max_length=255, blank=True, )
...
class Study(models.Model):
      ...
      name = models.CharField(max_length=255, null=False, default='untitled', verbose_name='Study name', help_text='The name of the study', blank=True, )
      studytypecode = models.ForeignKey(Lookupstudytype, db_column='studytypecode', related_name='+', max_length=255, null=False, default='B', verbose_name='Study type', help_text='The type of the study', blank=True, )
      ...
      parentid = models.ForeignKey(Event, db_column='parentid', related_name='+', null=True, default='0', verbose_name='Parent event', help_text='The event of which this is a study', blank=True, )
      ...
      geobaseid = models.ForeignKey(Geobase, db_column='geobaseid', related_name='+', null=False, default='0', verbose_name='Geobase', help_text='The geographic basis of the study, eg Italy GADM Level 1. Can also be intensity level zones for the event', max_length=255, blank=True, )
      ...
      damagepercentage = models.ForeignKey(Lookupyesno, db_column='damagepercentage', related_name='+', null=False, default='0', verbose_name='Damage data is in percentages', help_text='Is the damage data in percentages?', blank=True, blank=True, )
      ...
      casualtypercentage = models.ForeignKey(Lookupyesno, db_column='casualtypercentage', related_name='+', null=False, default='0', verbose_name='Casualty data is in percentages', help_text='Is the casualty data in percentages?', blank=True, blank=True, )
      overallimpact = models.TextField(null=True, blank=True, verbose_name='Overall impact', help_text='Overall impact of shaking', )
      reliabilitydataqualitycode = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitydataqualitycode', related_name='+', max_length=10, null=False, default='0', verbose_name='Reliability: Data quality', help_text='Quality of source data', blank=True, blank=True, )
      reliabilitydocumentationqualitycode = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitydocumentationqualitycode', related_name='+', max_length=10, null=False, default='0', verbose_name='Reliability: Documentation quality', help_text='How well the author has documented the data, analysis and results', blank=True, blank=True, )
      reliabilitylocationalcode = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitylocationalcode', related_name='+', max_length=10, null=False, default='0', verbose_name='Reliability: Locational', help_text='How reliable the geographic locations are', blank=True, blank=True, )
...
class Socioeconomicstudy(models.Model):
      id = models.AutoField(primary_key=True, null=False, help_text='Primary Key: Internal database id', blank=True, )
      name = models.CharField(max_length=255, null=False, default='untitled', verbose_name='Study name', help_text='The name of the socio-economic study', blank=True, )
      ...
      numberofdwellingunitsdestroyed_q = models.ForeignKey(Lookupstatus, db_column='numberofdwellingunitsdestroyed_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of dwelling units destroyed: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofdwellingunitsdamaged_q = models.ForeignKey(Lookupstatus, db_column='numberofdwellingunitsdamaged_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of dwelling units damaged: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totalnumberofhouseholdscountry_q = models.ForeignKey(Lookupstatus, db_column='totalnumberofhouseholdscountry_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total number of households in the affected country: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totalnumberofhouseholdsarea_q = models.ForeignKey(Lookupstatus, db_column='totalnumberofhouseholdsarea_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total number of households in the affected area: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofbuildingsdestroyed_q = models.ForeignKey(Lookupstatus, db_column='numberofbuildingsdestroyed_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of buildings destroyed: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofeducationalbuildingsdestroyedordamaged_q = models.ForeignKey(Lookupstatus, db_column='numberofeducationalbuildingsdestroyedordamaged_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of educational buildings destroyed or damaged: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      costofeducationalbuildingsdestroyedordamaged_q = models.ForeignKey(Lookupstatus, db_column='costofeducationalbuildingsdestroyedordamaged_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Cost of damage to educational buildings: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofhealthfacilitiesdestroyedordamaged_q = models.ForeignKey(Lookupstatus, db_column='numberofhealthfacilitiesdestroyedordamaged_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of health facilities destroyed or damaged: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      percentageofhealthfacilitiesdestroyedordamaged_q = models.ForeignKey(Lookupstatus, db_column='percentageofhealthfacilitiesdestroyedordamaged_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Percentage of health facilities destroyed or damaged: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      costofhealthfacilitiesdestroyedordamaged_q = models.ForeignKey(Lookupstatus, db_column='costofhealthfacilitiesdestroyedordamaged_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Cost of health facilities destroyed or damaged: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofpeopletempwithoutelectricity_q = models.ForeignKey(Lookupstatus, db_column='numberofpeopletempwithoutelectricity_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of people without electricity in the immediate aftermath: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      percentageofpeopletempwithoutelectricity_q = models.ForeignKey(Lookupstatus, db_column='percentageofpeopletempwithoutelectricity_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Percentage of people without electricity in the immediate aftermath: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofpeoplesigwithoutelectricity_q = models.ForeignKey(Lookupstatus, db_column='numberofpeoplesigwithoutelectricity_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of people without electricity for a significant time: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      percentageofpeoplesigwithoutelectricity_q = models.ForeignKey(Lookupstatus, db_column='percentageofpeoplesigwithoutelectricity_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Percentage of people without electricity for a significant time: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofpeopletempwithoutwater_q = models.ForeignKey(Lookupstatus, db_column='numberofpeopletempwithoutwater_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of people without water in the immediate aftermath: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      percentageofpeopletempwithoutwater_q = models.ForeignKey(Lookupstatus, db_column='percentageofpeopletempwithoutwater_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Percentage of people without water in the immediate aftermath: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofpeoplesigwithoutwater_q = models.ForeignKey(Lookupstatus, db_column='numberofpeoplesigwithoutwater_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of people without water for a significant time: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      percentageofpeoplesigwithoutwater_q = models.ForeignKey(Lookupstatus, db_column='percentageofpeoplesigwithoutwater_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Percentage of people without water for a significant time: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      datestampfornumberofpeoplesigwithoutwater_q = models.ForeignKey(Lookupstatus, db_column='datestampfornumberofpeoplesigwithoutwater_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Date stamp for number of people without water for a significant time: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberoftemphomeless_q = models.ForeignKey(Lookupstatus, db_column='numberoftemphomeless_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of people homeless in the immediate aftermath: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      datestampfornumberoftemphomeless_q = models.ForeignKey(Lookupstatus, db_column='datestampfornumberoftemphomeless_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Date stamp for number of people homeless in the immediate aftermath: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofsighomeless_q = models.ForeignKey(Lookupstatus, db_column='numberofsighomeless_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of people homeless for a significant duration of time: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      datestampfornumberofsighomeless_q = models.ForeignKey(Lookupstatus, db_column='datestampfornumberofsighomeless_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Date Stamp for the number of people homeless for a significant duration of time: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberunemployed_q = models.ForeignKey(Lookupstatus, db_column='numberunemployed_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Number of people unemployed due to damage to the production, commercial and service sectors: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totaldirecteconomicloss_q = models.ForeignKey(Lookupstatus, db_column='totaldirecteconomicloss_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total direct economic losses: status', help_text='The status of the data', blank=True, blank=True, )
      totaldirecteconomiclosspersector = models.TextField(verbose_name='Total direct economic losses per sector', help_text='Total direct economic losses per sector (contemporaneous)', blank=True, blank=True, )
      ...
      totaldirecteconomiclosspersector_q = models.ForeignKey(Lookupstatus, db_column='totaldirecteconomiclosspersector_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total direct economic losses per sector: status', help_text='The status of the data', blank=True, blank=True, )
      totaldirecteconomiclossbyhazard = models.TextField(verbose_name='Total direct economic losses by type of hazard', help_text='Total direct economic losses by type of hazard (contemporaneous)', blank=True, blank=True, )
      ...
      totaldirecteconomiclossbyhazard_q = models.ForeignKey(Lookupstatus, db_column='totaldirecteconomiclossbyhazard_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total direct economic losses by type of hazard: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totalindirecteconomicloss_q = models.ForeignKey(Lookupstatus, db_column='totalindirecteconomicloss_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total indirect economic losses: status', help_text='The status of the data', blank=True, blank=True, )
      totalindirecteconomiclossbycause = models.TextField(verbose_name='Total indirect economic losses by cause', help_text='Total indirect economic losses by cause (in contemporaneous US$)', blank=True, blank=True, )
      ...
      totalindirecteconomiclossbycause_q = models.ForeignKey(Lookupstatus, db_column='totalindirecteconomiclossbycause_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total indirect economic losses by cause: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      countrygdp_q = models.ForeignKey(Lookupstatus, db_column='countrygdp_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Contemporaneous country GDP: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totaldirecteconomiclossaspercentofgdp_q = models.ForeignKey(Lookupstatus, db_column='totaldirecteconomiclossaspercentofgdp_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total direct economic losses as % of contemporaneous GDP: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totalindirecteconomiclossaspercentofgdp_q = models.ForeignKey(Lookupstatus, db_column='totalindirecteconomiclossaspercentofgdp_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Total indirect economic losses as % of contemporaneous GDP: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      presentcountrygdp_q = models.ForeignKey(Lookupstatus, db_column='presentcountrygdp_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Present-time country GDP: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      insurancelosses_q = models.ForeignKey(Lookupstatus, db_column='insurancelosses_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Insurance losses: status', help_text='The status of the data', blank=True, blank=True, )
      insurancelossesbyhazard = models.TextField(verbose_name='Insurance losses by type of hazard', help_text='Insurance losses (contemporaneous) by type of hazard', blank=True, blank=True, )
      ...
      insurancelossesbyhazard_q = models.ForeignKey(Lookupstatus, db_column='insurancelossesbyhazard_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Insurance losses by type of hazard: status', help_text='The status of the data', blank=True, blank=True, )
      insurancelossesbybusiness = models.TextField(verbose_name='Insurance losses by line of business', help_text='Insurance losses (contemporaneous) by line of business', blank=True, blank=True, )
      ...
      insurancelossesbybusiness_q = models.ForeignKey(Lookupstatus, db_column='insurancelossesbybusiness_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Insurance losses by line of business: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      reconstructioncost_q = models.ForeignKey(Lookupstatus, db_column='reconstructioncost_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Cost of reconstruction: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      aidcontribution_q = models.ForeignKey(Lookupstatus, db_column='aidcontribution_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Amount of aid contribution: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      multiplier_q = models.ForeignKey(Lookupstatus, db_column='multiplier_q', related_name='+', max_length=10, null=False, default='0', verbose_name='Multiplier to project the contemporaneous losses, costs, aid contributions: status', help_text='The status of the data', blank=True, blank=True, )
      reliabilityoverallid = models.ForeignKey(Lookupqualitymetric, db_column='reliabilityoverallid', related_name='+', null=False, default='0', verbose_name='Reliability: Overall', help_text='Overall reliability of source data', blank=True, blank=True, )
      reliabilitydataqualityid = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitydataqualityid', related_name='+', null=False, default='0', verbose_name='Reliability: Data quality', help_text='Quality of source data', blank=True, blank=True, )
      reliabilitydatarelevanceid = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitydatarelevanceid', related_name='+', null=False, default='0', verbose_name='Reliability: Data relevance', help_text='How well the data matches or envelopes the conditions that will be encountered', blank=True, blank=True, )
      reliabilitydocumentationqualityid = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitydocumentationqualityid', related_name='+', null=False, default='0', verbose_name='Reliability: Documentation quality', help_text='How well the author has documented the data, analysis and results', blank=True, blank=True, )
      reliabilityrationalityid = models.ForeignKey(Lookupqualitymetric, db_column='reliabilityrationalityid', related_name='+', null=False, default='0', verbose_name='Reliability: Rationality', help_text='How well the the behavior can be explained or rationalized by intuition, calculation or principles of engineering mechanics', blank=True, blank=True, )
      reliabilitylocationalid = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitylocationalid', related_name='+', null=False, default='0', verbose_name='Reliability: Locational', help_text='How reliable the geographic locations are', blank=True, blank=True, )
      reliability_c = models.TextField(null=True, blank=True, verbose_name='Study reliability: comment', help_text='A comment on the study reliability', )
      ...
      originallanguage = models.CharField(max_length=50, null=True, blank=True, verbose_name='Language of original study', help_text='The original language of the study', )
      ownerid = models.IntegerField(null=False, default='1', verbose_name='Owner ID', help_text='ID of the creator/owner of the record', max_length=50, blank=True, )
      lastupdatebyid = models.IntegerField(null=False, default='1', verbose_name='Last update by ID', help_text='ID of the last person to update this record', max_length=50, blank=True, )
      lastupdate = models.DateTimeField(null=True, blank=True, help_text='Last record update date', )
...
class Tsunamistudy(models.Model):
      id = models.AutoField(primary_key=True, null=False, help_text='Primary Key: Internal database id', blank=True, )
      name = models.CharField(max_length=255, null=False, default='untitled', verbose_name='Study name', help_text='The name of the tsunami study', blank=True, )
      authors = models.CharField(max_length=255, null=True, blank=True, verbose_name='Author(s)', help_text='The authors of the study, last name first e.g: Smith, J. A; Jones, F;', )
      studydate = models.DateTimeField(null=True, blank=True, verbose_name='Study publication date', help_text='Study publication date, eg 1980-05-31', )
      parentid = models.ForeignKey(Event, db_column='parentid', related_name='+', null=True, default='0', verbose_name='Parent event', help_text='The event of which this is a study', blank=True, )
      sources = models.TextField(null=True, blank=True, verbose_name='Sources and web links for the study', help_text='Sources and web links for the study', )
      ...
      totalcoastaffected_q = models.ForeignKey(Lookupstatus, db_column='totalcoastaffected_q', related_name='+', null=False, default='0', verbose_name='Total length of coast affected: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totallandflooded_q = models.ForeignKey(Lookupstatus, db_column='totallandflooded_q', related_name='+', null=False, default='0', verbose_name='Total land area flooded by the tsunami: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      peopleinsideinundationzone_q = models.ForeignKey(Lookupstatus, db_column='peopleinsideinundationzone_q', related_name='+', null=False, default='0', verbose_name='Population inside the tsunami inundation zone: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      peopleinjuredduetotsunami_q = models.ForeignKey(Lookupstatus, db_column='peopleinjuredduetotsunami_q', related_name='+', null=False, default='0', verbose_name='People injured due to tsunami: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      peopledyingpostcatastrophe_q = models.ForeignKey(Lookupstatus, db_column='peopledyingpostcatastrophe_q', related_name='+', null=False, default='0', verbose_name='People dying post catastrophe: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberbuildingswashedaway_q = models.ForeignKey(Lookupstatus, db_column='numberbuildingswashedaway_q', related_name='+', null=False, default='0', verbose_name='Number of buildings washed away: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberbuildingsflooded_q = models.ForeignKey(Lookupstatus, db_column='numberbuildingsflooded_q', related_name='+', null=False, default='0', verbose_name='Number of buildings flooded: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberbridgesdestroyed_q = models.ForeignKey(Lookupstatus, db_column='numberbridgesdestroyed_q', related_name='+', null=False, default='0', verbose_name='Number of bridges destroyed: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberportsaffected_q = models.ForeignKey(Lookupstatus, db_column='numberportsaffected_q', related_name='+', null=False, default='0', verbose_name='Number of ports affected: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberboatsdestroyed_q = models.ForeignKey(Lookupstatus, db_column='numberboatsdestroyed_q', related_name='+', null=False, default='0', verbose_name='Number of boats destroyed: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numbervehiclesdestroyed_q = models.ForeignKey(Lookupstatus, db_column='numbervehiclesdestroyed_q', related_name='+', null=False, default='0', verbose_name='Number of vehicles destroyed: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofbuildingsdestroyed_q = models.ForeignKey(Lookupstatus, db_column='numberofbuildingsdestroyed_q', related_name='+', null=False, default='0', verbose_name='Total number of buildings destroyed: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofbuildingsdamaged_q = models.ForeignKey(Lookupstatus, db_column='numberofbuildingsdamaged_q', related_name='+', null=False, default='0', verbose_name='Number of buildings damaged: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofdwellingsdestroyed_q = models.ForeignKey(Lookupstatus, db_column='numberofdwellingsdestroyed_q', related_name='+', null=False, default='0', verbose_name='Number of dwellings destroyed: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofdwellingsdamaged_q = models.ForeignKey(Lookupstatus, db_column='numberofdwellingsdamaged_q', related_name='+', null=False, default='0', verbose_name='Number of dwellings damaged: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      peoplehomeless_q = models.ForeignKey(Lookupstatus, db_column='peoplehomeless_q', related_name='+', null=False, default='0', verbose_name='People homeless: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      directeconomicloss_q = models.ForeignKey(Lookupstatus, db_column='directeconomicloss_q', related_name='+', null=False, default='0', verbose_name='Direct economic loss: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      indirecteconomicloss_q = models.ForeignKey(Lookupstatus, db_column='indirecteconomicloss_q', related_name='+', null=False, default='0', verbose_name='Indirect economic loss: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberofhouseholds_q = models.ForeignKey(Lookupstatus, db_column='numberofhouseholds_q', related_name='+', null=False, default='0', verbose_name='Number of households: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totalnumberofbuildings_q = models.ForeignKey(Lookupstatus, db_column='totalnumberofbuildings_q', related_name='+', null=False, default='0', verbose_name='Total number of buildings: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      reliabilitydataqualitycode = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitydataqualitycode', related_name='+', max_length=10, null=True, default='0', verbose_name='Reliability: Data quality', help_text='Quality of source data', blank=True, )
      reliabilitydocumentationqualitycode = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitydocumentationqualitycode', related_name='+', max_length=10, null=True, default='0', verbose_name='Reliability: Documentation quality', help_text='How well the author has documented the data, analysis and results', blank=True, )
      reliabilitylocationalcode = models.ForeignKey(Lookupqualitymetric, db_column='reliabilitylocationalcode', related_name='+', max_length=10, null=True, default='0', verbose_name='Reliability: Locational', help_text='How reliable the geographic locations are', blank=True, )
      reliability_c = models.TextField(null=True, blank=True, verbose_name='Study reliability: comment', help_text='A comment on the study reliability', )
      significantfigures = models.IntegerField(null=True, blank=True, verbose_name='Significant figures', help_text='The significant figures for the data in the study', )
      ownerid = models.IntegerField(null=True, default='1', verbose_name='Owner ID', help_text='ID of the creator/owner of the record', blank=True, )
      lastupdatebyid = models.IntegerField(null=True, default='1', verbose_name='Last update by ID', help_text='ID of the last person to update this record', blank=True, )
...
class Slopefailurestudy(models.Model):
      id = models.AutoField(primary_key=True, null=False, help_text='Primary Key: Internal database id', blank=True, )
      name = models.CharField(max_length=255, null=False, default='untitled', verbose_name='Study name', help_text='The name of the slope failure study', blank=True, )
      authors = models.CharField(max_length=255, null=True, blank=True, verbose_name='Author(s)', help_text='The authors of the study, last name first e.g: Smith, J. A; Jones, F;', )
      studydate = models.DateTimeField(null=True, blank=True, verbose_name='Study publication date', help_text='Study publication date, eg 1980-05-31', )
      parentid = models.ForeignKey(Event, db_column='parentid', related_name='+', null=True, default='0', verbose_name='Parent event', help_text='The event of which this is a study', blank=True, )
      sources = models.TextField(null=True, blank=True, verbose_name='Sources and web links for the study', help_text='Sources and web links for the study', )
      ...
      peopleinjuredduetoslopefailures_q = models.ForeignKey(Lookupstatus, db_column='peopleinjuredduetoslopefailures_q', related_name='+', null=False, default='0', verbose_name='People injured due to slope failures: status', help_text='The status of the data', blank=True, blank=True, )
...
class Firefollowingstudy(models.Model):
      id = models.AutoField(primary_key=True, null=False, help_text='Primary Key: Internal database id', blank=True, )
      name = models.CharField(max_length=255, null=False, default='untitled', verbose_name='Study name', help_text='The name of the fire following study', blank=True, )
      authors = models.CharField(max_length=255, null=True, blank=True, verbose_name='Author(s)', help_text='The authors of the study, last name first e.g: Smith, J. A; Jones, F;', )
      studydate = models.DateTimeField(null=True, blank=True, verbose_name='Study publication date', help_text='Study publication date, eg 1980-05-31', )
      parentid = models.ForeignKey(Event, db_column='parentid', related_name='+', null=True, default='0', verbose_name='Parent event', help_text='The event of which this is a study', blank=True, )
      sources = models.TextField(null=True, blank=True, verbose_name='Sources and web links for the study', help_text='Sources and web links for the study', )
      ...
      finalburntarea_q = models.ForeignKey(Lookupstatus, db_column='finalburntarea_q', related_name='+', null=False, default='0', verbose_name='Final burnt area: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      totalnumberofignitions_q = models.ForeignKey(Lookupstatus, db_column='totalnumberofignitions_q', related_name='+', null=False, default='0', verbose_name='Total number of ignitions: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberoflargefires_q = models.ForeignKey(Lookupstatus, db_column='numberoflargefires_q', related_name='+', null=False, default='0', verbose_name='Number of large fires: status', help_text='The status of the data', blank=True, blank=True, )
      overallimpact = models.TextField(null=True, blank=True, verbose_name='Overall impact', help_text='Overall socio economic impact', )
      ...
      peopleinjuredduetofirefollowing_q = models.ForeignKey(Lookupstatus, db_column='peopleinjuredduetofirefollowing_q', related_name='+', null=False, default='0', verbose_name='People injured due to fire following: status', help_text='The status of the data', blank=True, blank=True, )
...
class Liquefactionstudy(models.Model):
      id = models.AutoField(primary_key=True, null=False, help_text='Primary Key: Internal database id', blank=True, )
      name = models.CharField(max_length=255, null=False, default='untitled', verbose_name='Study name', help_text='The name of the liquefaction study', blank=True, )
      authors = models.CharField(max_length=255, null=True, blank=True, verbose_name='Author(s)', help_text='The authors of the study, last name first e.g: Smith, J. A; Jones, F;', )
      studydate = models.DateTimeField(null=True, blank=True, verbose_name='Study publication date', help_text='Study publication date, eg 1980-05-31', )
      parentid = models.ForeignKey(Event, db_column='parentid', related_name='+', null=True, default='0', verbose_name='Parent event', help_text='The event of which this is a study', blank=True, )
      sources = models.TextField(null=True, blank=True, verbose_name='Sources and web links for the study', help_text='Sources and web links for the study', )
      ...
      totallandareaaffected_q = models.ForeignKey(Lookupstatus, db_column='totallandareaaffected_q', related_name='+', null=False, default='0', verbose_name='Total land area affected: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      peopleinsideliquefactionzone_q = models.ForeignKey(Lookupstatus, db_column='peopleinsideliquefactionzone_q', related_name='+', null=False, default='0', verbose_name='Population inside the liquefaction zone: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberbuildingssaffected_q = models.ForeignKey(Lookupstatus, db_column='numberbuildingssaffected_q', related_name='+', null=False, default='0', verbose_name='Number of buildings affected: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberbuildingspulleddown_q = models.ForeignKey(Lookupstatus, db_column='numberbuildingspulleddown_q', related_name='+', null=False, default='0', verbose_name='Number of buildings pulled down: status', help_text='The status of the data', blank=True, blank=True, )
      ...
      numberroadsaffected_q = models.ForeignKey(Lookupstatus, db_column='numberroadsaffected_q', related_name='+', null=False, default='0', verbose_name='Number of roads affected: status', help_text='The status of the data', blank=True, blank=True, )
      overallimpact = models.TextField(null=True, blank=True, verbose_name='Overall impact', help_text='Overall socio economic impact', )
