...
class Socioeconomicstudy(models.Model):
      ...
      numberofdwellingunitsdestroyed = models.FloatField(verbose_name='Number of dwelling units destroyed', help_text='Number of dwelling units destroyed (incl. shaking and secondary hazards)', )
      ...
      numberofdwellingunitsdamaged = models.FloatField(verbose_name='Number of dwelling units damaged', help_text='Number of dwelling units damaged (incl. shaking and secondary hazards)', )
      ...
      totalnumberofhouseholdscountry = models.FloatField(verbose_name='Total number of households in the affected country', help_text='Total number of households in the affected country (contemporaneous)', )
      ...
      totalnumberofhouseholdsarea = models.FloatField(verbose_name='Total number of households in the affected area', help_text='Estimated from EXPO-CAT total number of households in the affected area (contemporaneous)', )
      ...
      numberofbuildingsdestroyed = models.FloatField(verbose_name='Number of buildings destroyed', help_text='Number of buildings destroyed (incl. shaking and secondary hazards)', )
      ...
      numberofbuildingsdamaged = models.FloatField(verbose_name='Number of buildings damaged', help_text='Number of buildings damaged (incl. shaking and secondary hazards)', )
      ...
      numberofeducationalbuildingsdestroyedordamaged = models.FloatField(verbose_name='Number of educational buildings destroyed or damaged', help_text='Educational buildings destroyed or damaged', )
      ...
      percentageofeducationalbuildingsdestroyedordamaged = models.FloatField(verbose_name='Percentage of educational buildings destroyed or damaged', help_text='Educational buildings destroyed or damaged', )
      ...
      costofeducationalbuildingsdestroyedordamaged = models.FloatField(verbose_name='Cost of damage to educational buildings', help_text='Educational buildings destroyed or damaged (contemporaneous)', )
      ...
      numberofhealthfacilitiesdestroyedordamaged = models.FloatField(verbose_name='Number of health facilities destroyed or damaged', help_text='Health facilities (hospitals and clinics) destroyed or damaged', )
      ...
      percentageofhealthfacilitiesdestroyedordamaged = models.FloatField(verbose_name='Percentage of health facilities destroyed or damaged', help_text='Health facilities (hospitals and clinics) destroyed or damaged', )
      ...
      costofhealthfacilitiesdestroyedordamaged = models.FloatField(verbose_name='Cost of health facilities destroyed or damaged', help_text='Health facilities (hospitals and clinics) destroyed or damaged (contemporaneous)', )
      ...
      numberofpeopletempwithoutelectricity = models.FloatField(verbose_name='Number of people without electricity in the immediate aftermath', help_text='Number of people losing electricity supply in the immediate aftermath', )
      ...
      percentageofpeopletempwithoutelectricity = models.FloatField(verbose_name='Percentage of people without electricity in the immediate aftermath', help_text='Percentage of people losing electricity supply in the immediate aftermath', )
      ...
      datestampfornumberofpeopletempwithoutelectricity = models.DateTimeField(verbose_name='Date stamp for number of people without electricity in the immediate aftermath', help_text='Date stamp for the number of people losing electricity supply in the immediate aftermath - eg 1980-05-31', )
      ...
      numberofpeoplesigwithoutelectricity = models.FloatField(verbose_name='Number of people without electricity for a significant time', help_text='Number of people losing electricity supply for a significant duration of time', )
      ...
      percentageofpeoplesigwithoutelectricity = models.FloatField(verbose_name='Percentage of people without electricity for a significant time', help_text='Percentage of people losing electricity supply for a significant duration of time', )
      ...
      datestampfornumberofpeoplesigwithoutelectricity = models.DateTimeField(verbose_name='Date stamp for number of people without electricity for a significant time', help_text='Date Stamp for the number of people losing electricity supply for a significant duration of time - eg 1980-05-31', )
      ...
      numberofpeopletempwithoutwater = models.FloatField(verbose_name='Number of people without water in the immediate aftermath', help_text='Number of people losing water supply in the immediate aftermath', )
      ...
      percentageofpeopletempwithoutwater = models.FloatField(verbose_name='Percentage of people without water in the immediate aftermath', help_text='Percentage of people losing water supply in the immediate aftermath', )
      ...
      datestampfornumberofpeopletempwithoutwater = models.DateTimeField(verbose_name='Date stamp for number of people without water in the immediate aftermath', help_text='Date stamp for the number of people losing water supply in the immediate aftermath - eg 1980-05-31', )
      ...
      numberofpeoplesigwithoutwater = models.FloatField(verbose_name='Number of people without water for a significant time', help_text='Number of people losing water supply for a significant duration of time', )
      ...
      percentageofpeoplesigwithoutwater = models.FloatField(verbose_name='Percentage of people without water for a significant time', help_text='Percentage of people losing water supply for a significant duration of time', )
      ...
      datestampfornumberofpeoplesigwithoutwater = models.DateTimeField(verbose_name='Date stamp for number of people without water for a significant time', help_text='Date stamp for the number of people losing water supply for a significant duration of time', )
      ...
      numberoftemphomeless = models.FloatField(verbose_name='Number of people homeless in the immediate aftermath', help_text='Number of people homeless in the immediate aftermath', )
      ...
      datestampfornumberoftemphomeless = models.DateTimeField(verbose_name='Date stamp for number of people homeless in the immediate aftermath', help_text='Date Stamp for the number of people homeless in the immediate aftermath', )
      ...
      numberofsighomeless = models.FloatField(verbose_name='Number of people homeless for a significant duration of time', help_text='Number of people homeless for a significant duration of time', )
      ...
      datestampfornumberofsighomeless = models.DateTimeField(verbose_name='Date Stamp for the number of people homeless for a significant duration of time', help_text='Date Stamp for the number of people homeless for a significant duration of time', )
      ...
      numberunemployed = models.FloatField(verbose_name='Number of people unemployed due to damage to the production, commercial and service sectors', help_text='Number of people losing employment as a direct result of the damage to the production / commercial / service sector units', )
      ...
      totaldirecteconomicloss = models.FloatField(verbose_name='Total direct economic losses', help_text='Total direct economic losses (contemporaneous)', )
      ...
      totaldirecteconomiclosspersector = models.TextField(verbose_name='Total direct economic losses per sector', help_text='Total direct economic losses per sector (contemporaneous)', )
      ...
      totaldirecteconomiclossbyhazard = models.TextField(verbose_name='Total direct economic losses by type of hazard', help_text='Total direct economic losses by type of hazard (contemporaneous)', )
      ...
      totalindirecteconomicloss = models.FloatField(verbose_name='Total indirect economic losses', help_text='Total indirect economic losses (contemporaneous)', )
      ...
      totalindirecteconomiclossbycause = models.TextField(verbose_name='Total indirect economic losses by cause', help_text='Total indirect economic losses by cause (in contemporaneous US$)', )
      ...
      countrygdp = models.FloatField(verbose_name='Contemporaneous country GDP', help_text='Contemporaneous country GDP (US$)', )
      ...
      totaldirecteconomiclossaspercentofgdp = models.FloatField(verbose_name='Total direct economic losses as % of contemporaneous GDP', help_text='Total direct economic losses as % of contemporaneous GDP', )
      ...
      totalindirecteconomiclossaspercentofgdp = models.FloatField(verbose_name='Total indirect economic losses as % of contemporaneous GDP', help_text='Total indirect economic losses as % of contemporaneous GDP', )
      ...
      presentcountrygdp = models.FloatField(verbose_name='Present-time country GDP', help_text='Present-time country GDP', )
      ...
      insurancelosses = models.FloatField(verbose_name='Insurance losses', help_text='Insurance losses (contemporaneous)', )
      ...
      insurancelossesbyhazard = models.TextField(verbose_name='Insurance losses by type of hazard', help_text='Insurance losses (contemporaneous) by type of hazard', )
      ...
      insurancelossesbybusiness = models.TextField(verbose_name='Insurance losses by line of business', help_text='Insurance losses (contemporaneous) by line of business', )
      ...
      reconstructioncost = models.FloatField(verbose_name='Cost of reconstruction', help_text='Cost of reconstruction (contemporaneous)', )
      ...
      aidcontribution = models.FloatField(verbose_name='Amount of aid contribution', help_text='Amount of aid contribution', )
      ...
      multiplier = models.FloatField(verbose_name='Multiplier to project the contemporaneous losses, costs, aid contributions', help_text='Multiplier to project the contemporaneous losses, costs, aid contributions', )
...
class Liquefactionstudy(models.Model):
      ...
      numberbuildingsaffected = models.IntegerField(verbose_name='Number of buildings affected', help_text='Number of buildings affected', )
