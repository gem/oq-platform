...
export DISPLAY=:1
python openquakeplatform/test/nose_runner.py --failurecatcher dev -v --with-xunit --xunit-file=xunit-platform-dev.xml  openquakeplatform/test openquakeplatform_ipt/test
sleep 3
fab stop
"
...
export DISPLAY=:1
python openquakeplatform/test/nose_runner.py --failurecatcher prod -v --with-xunit --xunit-file=xunit-platform-prod.xml  openquakeplatform/test openquakeplatform_ipt/test
sleep 3
cd -
"
